  ...
  async up (queryInterface, Sequelize) {
     ...
     await queryInterface.bulkInsert('croppests', [
      ...
      },
      {
        ...
        cropId:6,
        pestId:33,
        comment:"<p>分生孢子會感染大豆全部生育期間之植珠，而子囊孢子只會感染成株，初期於莖、莢等部位呈不規則形的褐斑，至後期被感染部位形成許多黑色的子實體，有如細小之針氈狀，此乃其剛毛、分生子梗及分生胞子。豆莢早期被害後，無法形成種子或種子呈黑褐色黴狀而且皺縮。罹病種子種植後，幼苗子葉上常呈現黑褐色下陷病徵。潮濕時變成水浸狀，快速萎凋而脫落。</p>",
        createdAt: "2023-08-12",
        updatedAt: "2023-08-12",
      }
