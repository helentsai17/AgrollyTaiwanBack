...
router.post('/add', async (req, res) => {
    const { cropId, initial_max_temp, initial_min_temp, dev_max_temp, dev_min_temp, mid_max_temp, mid_min_temp, last_max_temp, last_min_temp, harvest_max_temp, harvest_min_temp  } = req.body
...
router.put('/edit/:id', async (req, res) => {
    ...
    try {
        const temperature = await Temperature.findOne({ where: { id: Id } })
